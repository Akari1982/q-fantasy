...
//                                                   const char* device_name, Error* error = nullptr);
  static std::unique_ptr<AudioStream> CreateStream( u32 sample_rate );
...
//                                                           Error* error);
  static std::unique_ptr<AudioStream> CreateOfAudioStream(u32 sample_rate, const AudioStreamParameters& parameters );
//#else
