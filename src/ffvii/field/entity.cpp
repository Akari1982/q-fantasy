...
void FieldEntityDebugAddToRender(OTag* ot, MATRIX* m)
{
    ...
    for (u32 i = 0; i < g_field_wm.size(); ++i)
    {
        PsyqRotTransPers(&g_field_wm[i].p1, &sxy1, &pt, &flag);
        PsyqRotTransPers(&g_field_wm[i].p2, &sxy2, &pt, &flag);
        PsyqRotTransPers(&g_field_wm[i].p3, &sxy3, &pt, &flag);

        PsyqSetLineF2(&wm_poly[i * 3 + 0]);
        PsyqSetSemiTrans(&wm_poly[i * 3 + 0], 0);
        wm_poly[i * 0x3 + 0x0].r0 = 0x7f;
        wm_poly[i * 0x3 + 0x0].g0 = 0x0;
        wm_poly[i * 0x3 + 0x0].b0 = 0x0;
        wm_poly[i * 0x3 + 0x0].x0 = sxy1.vx;
        wm_poly[i * 0x3 + 0x0].y0 = sxy1.vy;
        wm_poly[i * 0x3 + 0x0].x1 = sxy2.vx;
        wm_poly[i * 0x3 + 0x0].y1 = sxy2.vy;
        PsyqAddPrim(ot, &wm_poly[i * 0x3 + 0x0]);

        PsyqSetLineF2(&wm_poly[i * 3 + 1]);
        PsyqSetSemiTrans(&wm_poly[i * 3 + 1], 0);
        wm_poly[i * 0x3 + 0x1].r0 = 0x7f;
        wm_poly[i * 0x3 + 0x1].g0 = 0x0;
        wm_poly[i * 0x3 + 0x1].b0 = 0x0;
        wm_poly[i * 0x3 + 0x1].x0 = sxy1.vx;
        wm_poly[i * 0x3 + 0x1].y0 = sxy1.vy;
        wm_poly[i * 0x3 + 0x1].x1 = sxy3.vx;
        wm_poly[i * 0x3 + 0x1].y1 = sxy3.vy;
        PsyqAddPrim(ot, &wm_poly[i * 0x3 + 0x1]);

        PsyqSetLineF2(&wm_poly[i * 0x3 + 0x2]);
        PsyqSetSemiTrans(&wm_poly[i * 0x3 + 0x2], 0);
        wm_poly[i * 0x3 + 0x2].r0 = 0x7f;
        wm_poly[i * 0x3 + 0x2].g0 = 0x0;
        wm_poly[i * 0x3 + 0x2].b0 = 0x0;
        wm_poly[i * 0x3 + 0x2].x0 = sxy2.vx;
        wm_poly[i * 0x3 + 0x2].y0 = sxy2.vy;
        wm_poly[i * 0x3 + 0x2].x1 = sxy3.vx;
        wm_poly[i * 0x3 + 0x2].y1 = sxy3.vy;
