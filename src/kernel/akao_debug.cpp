...
{
    "", "(empty)", "Opening - Bombing Mission", "Bombing Mission", "", "", "", "Mako Reactor", "", "", "Anxiety",        "", "", "", "", "",
    "", "",        "",                          "",                "", "", "", "",             "", "", "",               "", "", "", "", "",
    "", "",        "",                          "Tifa's Theme",    "", "", "", "",             "", "", "Barret's Theme", "", "", "", "", "",
    "", "",        "",                          "",                "", "", "", "Hurry!",       "", "", "",               "", "", "", "", "",
    "", "",        "",                          "",                "", "", "", "",             "", "", "",               "", "", "", "", "",
    "", "",        "",                          "",                "", "", "", "",             "", "", "",               "", "", "", "", "", "The Prelude"
};
...
{
    "", "",        "オープニング~爆破ミッション",   "爆破ミッション",    "", "", "", "魔晄炉",       "", "", "不安な心",       "", "", "", "", "",
    "", "",        "",                          "",                "", "", "", "",            "", "", "",              "", "", "", "", "",
    "", "",        "",                          "ティファのテーマ",  "", "", "", "",            "", "", "バレットのテーマ", "", "", "", "", "",
    "", "",        "",                          "",                "", "", "", "急げ!",        "", "", "",              "", "", "", "", "",
    "", "",        "",                          "",                "", "", "", "",            "", "", "",              "", "", "", "", "",
...
static void AkaoDebugFillSongInfo()
{
    ...
    for( int i = 0; i < g_musics.size(); ++i )
    {
        std::sort(g_musics[i].files.begin(), g_musics[i].files.end(),
            ...
            {
                return a.path < b.path; // сравнение строк
            }
        );
    }
}
