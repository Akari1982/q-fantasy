...
set (OPENSSL_EXTERNALCMAKE_BUILD_SHARED_LIBS OFF)
...
if(_ossl_use_static_libs)
  ...
  if (WIN32 OR CYGWIN)
    set(OPENSSL_LIBCRYPTO_SHARED "${OPENSSL_RUNTIME_DIR}/crypto.dll")
    ...
    set(OPENSSL_LIBSSL_SHARED "${OPENSSL_RUNTIME_DIR}/ssl.dll")
    ...
    set(OPENSSL_LIBCRYPTO_SHARED "${OPENSSL_LIBRARY_DIR}/crypto.dll")
    set_target_properties(OpenSSL::Crypto PROPERTIES
      IMPORTED_LINK_INTERFACE_LANGUAGES "C"
      IMPORTED_LOCATION ${OPENSSL_LIBCRYPTO_SHARED})

    set(OPENSSL_LIBSSL_SHARED "${OPENSSL_LIBRARY_DIR}/ssl.dll")
    set_target_properties(OpenSSL::SSL PROPERTIES
      IMPORTED_LINK_INTERFACE_LANGUAGES "C"
      IMPORTED_LOCATION ${OPENSSL_LIBSSL_SHARED})
